...
// NAMESPACE OBJECT: ./js/src/forms/input-controllers/index.js
var input_controllers_namespaceObject = {};
__webpack_require__.r(input_controllers_namespaceObject);
__webpack_require__.d(input_controllers_namespaceObject, {
  "NumberWithSteppers": () => (NumberWithSteppers),
  "SelectRadioList": () => (input_controllers_SelectRadioList)
});
...
;// CONCATENATED MODULE: ./node_modules/event-target-shim/index.mjs
/**
 * Assert a condition.
...
/* harmony default export */ const event_target_shim = ((/* unused pure expression or super */ null && (EventTarget)));

//# sourceMappingURL=index.mjs.map

;// CONCATENATED MODULE: ./js/src/forms/input-controllers/InputController.js
...
;// CONCATENATED MODULE: ./js/src/forms/input-controllers/SelectRadioList.js
...
function SelectRadioList_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }

function SelectRadioList_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) SelectRadioList_setPrototypeOf(subClass, superClass); }

function SelectRadioList_setPrototypeOf(o, p) { SelectRadioList_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return SelectRadioList_setPrototypeOf(o, p); }

function SelectRadioList_createSuper(Derived) { var hasNativeReflectConstruct = SelectRadioList_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = SelectRadioList_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = SelectRadioList_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return SelectRadioList_possibleConstructorReturn(this, result); }; }

function SelectRadioList_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return SelectRadioList_assertThisInitialized(self); }

function SelectRadioList_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function SelectRadioList_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function SelectRadioList_getPrototypeOf(o) { SelectRadioList_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return SelectRadioList_getPrototypeOf(o); }
...
var SelectRadioList = /*#__PURE__*/function (_InputController) {
  SelectRadioList_inherits(SelectRadioList, _InputController);

  var _super = SelectRadioList_createSuper(SelectRadioList);

  function SelectRadioList(element) {
    var _this;

    SelectRadioList_classCallCheck(this, SelectRadioList);

    _this = _super.call(this, element);
    _this.optionElements = Array.from(element.querySelectorAll("option"));
    _this.radioInputs = _this.generateRadioInputs();
    element.addEventListener("change", _this.handleSelectChange.bind(SelectRadioList_assertThisInitialized(_this)));
  ...
  _createClass(SelectRadioList, [{
    ...
    value: function generateRadioInputs() {
      ...
      return this.optionElements.map(function (option, index) {
        ...
        var optionId = `${_this2.name}-option-${index}`;
        var radioInput = document.createElement("input");
        radioInput.setAttribute("type", "radio");
        radioInput.setAttribute("value", optionValue);
        radioInput.setAttribute("name", `${_this2.name}-radio`);
        ...
        if (option.dataset.tag) {
          ...
          var _tagElement = document.createElement("span");

          _tagElement.className = "tag";
          _tagElement.innerText = option.dataset.tag;
          label.appendChild(_tagElement);
        }
...
/* harmony default export */ const input_controllers_SelectRadioList = (SelectRadioList);
;// CONCATENATED MODULE: ./js/src/forms/input-controllers/NumberWithSteppers.js


function NumberWithSteppers_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function NumberWithSteppers_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function NumberWithSteppers_createClass(Constructor, protoProps, staticProps) { if (protoProps) NumberWithSteppers_defineProperties(Constructor.prototype, protoProps); if (staticProps) NumberWithSteppers_defineProperties(Constructor, staticProps); return Constructor; }

function NumberWithSteppers_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) NumberWithSteppers_setPrototypeOf(subClass, superClass); }

function NumberWithSteppers_setPrototypeOf(o, p) { NumberWithSteppers_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return NumberWithSteppers_setPrototypeOf(o, p); }

function NumberWithSteppers_createSuper(Derived) { var hasNativeReflectConstruct = NumberWithSteppers_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = NumberWithSteppers_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = NumberWithSteppers_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return NumberWithSteppers_possibleConstructorReturn(this, result); }; }

function NumberWithSteppers_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } return NumberWithSteppers_assertThisInitialized(self); }

function NumberWithSteppers_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function NumberWithSteppers_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function NumberWithSteppers_getPrototypeOf(o) { NumberWithSteppers_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return NumberWithSteppers_getPrototypeOf(o); }




var NumberWithSteppers = /*#__PURE__*/function (_InputController) {
  NumberWithSteppers_inherits(NumberWithSteppers, _InputController);

  var _super = NumberWithSteppers_createSuper(NumberWithSteppers);

  function NumberWithSteppers(inputElement) {
    var _this;

    NumberWithSteppers_classCallCheck(this, NumberWithSteppers);
    ...
    minButton.addEventListener("click", _this.handleMinClick.bind(NumberWithSteppers_assertThisInitialized(_this)));
    var plusButton = document.createElement("button");
    plusButton.className = "stepper add";
    plusButton.addEventListener("click", _this.handePlusClick.bind(NumberWithSteppers_assertThisInitialized(_this)));
    wrapper.appendChild(plusButton);
    return _this;
  }

  NumberWithSteppers_createClass(NumberWithSteppers, [{
    key: "handleMinClick",
...
;// CONCATENATED MODULE: ./js/src/forms/input-controllers/index.js


;// CONCATENATED MODULE: ./js/src/animation/appearTransitions.js
...
;// CONCATENATED MODULE: ./js/src/animation/nextFrame.js
function nextFrame(fn) {
  requestAnimationFrame(function () {
    return requestAnimationFrame(fn);
  });
}
;// CONCATENATED MODULE: ./js/src/animation/prefersReducedMotion.js
function prefersReducedMotion() {
  var query = window.matchMedia("(prefers-reduced-motion: reduce)");
  return !query || query.matches;
}
;// CONCATENATED MODULE: ./js/src/animation/ExpandTransitionElement.js
function ExpandTransitionElement_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ExpandTransitionElement_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ExpandTransitionElement_createClass(Constructor, protoProps, staticProps) { if (protoProps) ExpandTransitionElement_defineProperties(Constructor.prototype, protoProps); if (staticProps) ExpandTransitionElement_defineProperties(Constructor, staticProps); return Constructor; }
...
var ExpandTransitionElement = /*#__PURE__*/function () {
  function ExpandTransitionElement() {
    ExpandTransitionElement_classCallCheck(this, ExpandTransitionElement);
  ...
  ExpandTransitionElement_createClass(ExpandTransitionElement, [{
    ...
    set: function set(visible) {
      ...
      if (visible) {
        ...
        nextFrame(function () {
          ...
          _this.element.style.maxHeight = scrollHeight ? `${_this.element.scrollHeight}px` : 'none';
        });
      } else {
    ...
    value: function refreshHeight() {
      ...
      nextFrame(function () {
        if (_this2.visible && _this2.element.style.maxHeight && _this2.element.style.maxHeight !== 'none') {
          var scrollHeight = _this2.element.scrollHeight;
          _this2.element.style.maxHeight = scrollHeight ? `${_this2.element.scrollHeight}px` : 'none';
        }
      });
    }
  }]);
...
;// CONCATENATED MODULE: ./js/src/reservation-form/templates.js
...
;// CONCATENATED MODULE: ./js/src/reservation-form/config.js
...
;// CONCATENATED MODULE: ./js/src/reservation-form/main.js
...
var fields, startTimeInput;

function main() {
  // render the start-time-input template (not visible) to make sure the field is initialized
  startTimeInput = getTemplateRender('start-time-input'); // remove dates in past

  var _iterator = main_createForOfIteratorHelper(reservationForm.elements.date.querySelectorAll('option')),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _dateOption = _step.value;
      var optionTime = new Date(`${_dateOption.value}${SHOW_DATE_UNTIL}`);

      if (isBefore(optionTime, new Date())) {
        reservationForm.elements.date.removeChild(_dateOption);
      }
  ...
  fields = Object.fromEntries(Array.from(reservationForm.elements).filter(function (element) {
    ...
    return [element.name, element.dataset.inputController ? new input_controllers_namespaceObject[element.dataset.inputController](element) : element];
  }));
  ...
  if (fields.date.optionElements.some(function (el) {
    return el.textContent.trim().length > 36;
  })) {
    var _iterator2 = main_createForOfIteratorHelper(fields.date.optionElements),
        _step2;

    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var dateOption = _step2.value;
        dateOption.textContent = dateOption.textContent.trim().replace(/^\S+/, function (match) {
  ...
  reservationForm.addEventListener("submit", function (e) {
    ...
    showMessageOnCatch(function () {
      submitReservation(_objectSpread(_objectSpread({}, Object.fromEntries(Object.entries(fields).map(function (_ref) {
...
function handleDateChange() {
  var _fields$date$selected = fields.date.selectedOptionElement.dataset,
      fullyBooked = _fields$date$selected.fullyBooked,
      special = _fields$date$selected.special,
      specialDescription = _fields$date$selected.specialDescription;
  getTemplateRender('fully-booked').visible = fullyBooked !== undefined;
  var specialElement = getTemplateRender('special-description');
...
function showFatalErrorMessage(e) {
  ...
  if (e.message) {
    var errorElement = fatalErrorElement.querySelector('pre');
    ...
    if (success) {
      ...
      if (_fields && _fields.length) {
        if (_fields.some(function (field) {
          ...
          var _iterator3 = main_createForOfIteratorHelper(feedbackElements),
              _step3;
